...
public class C206_CaseStudy {
	...
	public static void main(String[] args) {
		...
		CCA cca1 = new CCA("Little League Soccer", "Soccer Club for Boys", 30, "Wednesday", "2:00PM - 4:00PM",
				"School Field", "Mr Izzat", soccer);
		CCA cca2 = new CCA("LEGO Expert", "LEGO building masters", 40, "Tuesday", "2:00PM - 3:00PM", "E62A",
				"Mr Jordon", Lego);
	...
	public static void startInstructor(String[] daysList, ArrayList<Instructor> insList, ArrayList<CCA> ccaList,
	...
	public static void startAdmin(String[] daysList, ArrayList<Admin> adminList, ArrayList<CCA> ccaList,
			ArrayList<Student> studentList, ArrayList<Parent> parentList, ArrayList<Category> catList,
			ArrayList<CCA> emptyCCAlist) {
	...
	public static void startParent(ArrayList<Parent> parentList, ArrayList<CCA> ccaList,
			ArrayList<Student> studentList) {
...
=======
		output += String.format("%-23s %-25s %-13s %-12s %-18s %-15s %-10s\n", "TITLE", "DESCRIPTION", "VACANCY", "DAY",
				"TIME", "VENUE", "IN-CHARGE");
	...
	public static void viewAllStudents(ArrayList<Student> studList) {
		...
		for (int i = 0; i < studList.size(); i++) {
			output += String.format("%-10s%-15s%-10d%-10s%-20s%s\n", studList.get(i).getID(), studList.get(i).getName(),
					...
					studList.get(i).getRegistrationID());
		}
		System.out.println(output);
	}
...
//			 to generate random number
	...
	public static void deleteParent(ArrayList<Parent> parentList) {
		...
		for (int i = 0; i < parentList.size(); i++) {
			...
			System.out.println("parent account has been deleted");
		}else {
			System.out.println("no such parent account or has already been deleted");
		}
