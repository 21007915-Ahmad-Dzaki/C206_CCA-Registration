...
public class C206_CaseStudyTest {
	...
	public void testStudentsInCCA() {
		...
		//test that after setting student 1 isInCCA to true, isInCCA becomes true - normal
	...
	public void testLogin() {
		...
		assertSame("check that student id is the same",lily.getRegistrationID(),studentList.get(0).getRegistrationID());
